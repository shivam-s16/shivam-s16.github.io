...
const Card = ({
  ...
  return (
    <div
      ...
      className={`flex flex-col-reverse md:flex-row ${className} items-center justify-evenly rounded-lg py-8 px-8 md:px-0`}
    >
      <div className="md:w-1/5">
        ...
        {url && (
          <a href={url}>
            <button className={`${primaryVariant} px-4 py-2 mt-8`}>
              Learn More
            </button>
          </a>
        )}
      ...
      <div className="md:text-left md:w-3/5">
        <p className={`${primaryText} text-2xl font-semibold md:text-3xl`}>
          {title}
        </p>
